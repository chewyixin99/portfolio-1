    ...
    <body>
        ...
        <section class="intro" id="home">
            <h1 class="section__title section__title--intro">
                The title of <strong>showcase 05</strong>
            </h1>
            <p class="section__subtitle section__subtitle--intro">A short subtitle</p>
            <img src="../static/img/showcase_images/showcase-5.jpg"  alt="showcase-intro-img" class="intro__img">
        ...
        <div class="portfolio-item-individual">
            ...
            <img src="../static/img/showcase_images/showcase-5.jpg" alt="" class="intro__display__img">
            <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Saepe et amet tenetur! 
                Fugit sequi optio corrupti fugiat ducimus consequatur incidunt?</p>
