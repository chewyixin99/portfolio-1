...
if (isset($_GET['page_id'])) {
    ...
    if (isset($_POST['content'])) {
        ...
        $comment = new Comment($_GET['page_id'], $_POST['parent_id'], $name, $_POST['content'], $submit_date);
    ...
    $comments = $dao->getAllComments($_GET['page_id']);
...
<div class="comment_header">
    <span class="total"><?=$total_comments?> comments</span>
